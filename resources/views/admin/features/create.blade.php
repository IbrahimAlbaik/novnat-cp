                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="max-height: 300px; overflow-y: auto;">
                                            <!-- Dynamic Icon List -->
                                            <a class="dropdown-item" href="#" data-icon="fa-solid fa-circle-dollar-to-slot">
                                                <i class="fa-solid fa-circle-dollar-to-slot"></i> Solid Dollar Slot
                                            </a>
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-solid fa-building-wheat">--}}
{{--                                                <i class="fa-solid fa-building-wheat"></i> Solid Building Wheat--}}
{{--                                            </a>--}}
...
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-light fa-building">--}}
{{--                                                <i class="fa-light fa-building"></i> Light Building--}}
{{--                                            </a>--}}
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-regular fa-tree">--}}
{{--                                                <i class="fa-regular fa-tree"></i> Regular Tree--}}
{{--                                            </a>--}}
...
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-regular fa-leaf">--}}
{{--                                                <i class="fa-regular fa-leaf"></i> Regular Leaf--}}
{{--                                            </a>--}}
                                            ...
                                            <a class="dropdown-item" href="#" data-icon="fa-brands fa-canadian-maple-leaf">
                                                <i class="fa-brands fa-canadian-maple-leaf"></i> Canadian Maple Leaf
                                            </a>
                                            <a class="dropdown-item" href="#" data-icon="fa-solid fa-hand-holding-heart">
                                                <i class="fa-solid fa-hand-holding-heart"></i> Solid Hand Holding Heart
                                            </a>
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-regular fa-hand-holding-heart">--}}
{{--                                                <i class="fa-regular fa-hand-holding-heart"></i> Regular Hand Holding Heart--}}
{{--                                            </a>--}}
                                            <a class="dropdown-item" href="#" data-icon="fa-solid fa-hand-holding-droplet">
                                                <i class="fa-solid fa-hand-holding-droplet"></i> Solid Hand Holding Droplet
                                            </a>
{{--                                            <a class="dropdown-item" href="#" data-icon="fa-regular fa-hand-holding-droplet">--}}
{{--                                                <i class="fa-regular fa-hand-holding-droplet"></i> Regular Hand Holding Droplet--}}
{{--                                            </a>--}}
