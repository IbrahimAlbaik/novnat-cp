            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('faqs.create') }}" class="btn btn-primary btn-round ms-auto">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="{{ route('faqs.edit', $faq->id) }}" type="button"
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modal{{$faq->id}}" tabindex="-1"
